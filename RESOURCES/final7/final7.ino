...
void setup() {
  ...
  show_msg(2000,"OK");
  uint8_t tt=search_sheet_row(500);
  ...
  do {
    ...
    u8g.print("Ele");u8g.print(net_c,1);
  ...
  do {
    u8g.setFont(u8g_font_helvB12);  
    u8g.setPrintPos(0, 30);
    u8g.print(rtemp);u8g.print(" ");u8g.print(range);
    u8g.setPrintPos(0, 60);
    u8g.print("ELE");u8g.print("=");u8g.print(pelevation,1);
    u8g.setPrintPos(60, 60);
    u8g.print(rangediff);u8g.print(" ");u8g.print(rmill,1);
